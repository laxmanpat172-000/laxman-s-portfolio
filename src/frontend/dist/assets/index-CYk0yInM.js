...
function Footer({ theme }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-card border-t border-border/60", "data-ocid": "footer", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `h-0.5 w-full ${isColorful ? "bg-gradient-to-r from-primary via-accent to-chart-4" : "bg-gradient-to-r from-primary/50 to-accent/50"}`
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 py-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `w-10 h-10 rounded-xl flex items-center justify-center text-sm font-bold font-display text-primary-foreground ${isColorful ? "bg-gradient-to-br from-primary via-accent to-chart-4" : "bg-primary"}`,
                children: "LP"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground", children: "Laxman Patel" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "B.Tech CS Student" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground leading-relaxed", children: [
            "Passionate about building software solutions. Currently studying at",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground/70 font-medium", children: "SISTec GN, Bhopal" }),
            ". Learning every day to become a better engineer."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: `inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium w-fit border ${isColorful ? "bg-primary/10 border-primary/20 text-primary" : "bg-muted border-border/60 text-muted-foreground"}`,
              "data-ocid": "footer.theme_indicator",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `w-2 h-2 rounded-full ${isColorful ? "bg-gradient-to-r from-primary to-accent" : "bg-primary/70"}`
                  }
                ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-2.5", children: quickLinks.map(({ label, href }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1 h-1 rounded-full bg-primary/40 group-hover:bg-primary transition-smooth" }),
                label
              ]
            }
          ) }, href)) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground mb-4 text-sm uppercase tracking-wider", children: "Connect" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: socialLinks.map(({ label, href, icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href,
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 rounded-lg flex items-center justify-center transition-smooth border border-border/60 group-hover:border-primary/30 bg-muted/40 group-hover:bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-4 h-4" }) }),
                label
              ]
            },
            href
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 pt-6 border-t border-border/40 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "© ",
          currentYear,
          " Laxman Patel · Sagar Institute of Science and Technology (SISTec GN), Bhopal"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
...
function Header({ theme, onToggleTheme }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-smooth ${isScrolled ? "bg-card/90 backdrop-blur-xl border-b border-border/60 shadow-subtle" : "bg-transparent"}`,
      "data-ocid": "header",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: `w-9 h-9 rounded-lg flex items-center justify-center text-sm font-bold font-display text-primary-foreground transition-smooth shadow-md ${isColorful ? "bg-gradient-to-br from-primary via-accent to-chart-4" : "bg-primary"} group-hover:scale-110`,
                    children: "LP"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block font-display font-semibold text-foreground/90 group-hover:text-foreground transition-smooth", children: "Laxman Patel" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "nav",
            {
              ...
              children: navLinks.map(({ label, href }) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: `px-4 py-2 rounded-lg text-sm font-medium transition-smooth focus-ring ${isActive ? isColorful ? "bg-primary/20 text-primary" : "bg-primary/15 text-primary" : "text-muted-foreground hover:text-foreground hover:bg-muted/60"}`,
                    children: label
                  },
                  href
                );
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `relative flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold transition-smooth focus-ring border ${isColorful ? "bg-gradient-to-r from-primary/15 via-accent/15 to-chart-4/15 border-primary/30 text-primary hover:from-primary/25 hover:via-accent/25 hover:to-chart-4/25" : "bg-muted/60 border-border/60 text-muted-foreground hover:bg-muted hover:text-foreground"}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `relative w-9 h-5 rounded-full transition-smooth flex items-center ${isColorful ? "bg-gradient-to-r from-primary to-accent" : "bg-muted-foreground/30"}`,
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: `absolute w-3.5 h-3.5 rounded-full bg-white shadow-sm transition-smooth ${isColorful ? "translate-x-4" : "translate-x-0.5"}`
                        }
                      )
                    }
                  ),
                  isColorful ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Colorful" })
                  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "w-3.5 h-3.5" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Dark" })
                  ] })
                ]
              }
            ),
        ...
        isMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "container mx-auto px-4 py-4 flex flex-col gap-1", children: navLinks.map(({ label, href }) => {
              const sectionId = href.replace("#", "");
              const isActive = activeSection === sectionId;
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: `text-left px-4 py-3 rounded-lg text-sm font-medium transition-smooth ${isActive ? "bg-primary/15 text-primary" : "text-muted-foreground hover:text-foreground hover:bg-muted/60"}`,
                  children: label
                },
                href
              );
...
function Layout({ children, theme, onToggleTheme }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { theme, onToggleTheme }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, { theme })
  ] });
}
...
function applyTheme(theme) {
  ...
  root2.classList.add(DARK_CLASS);
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { theme, onToggleTheme: toggleTheme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, { theme }) }) });
}
